...
class Orders(Base):
    ...
    customer = Column(Integer, ForeignKey('customers.id'), nullable=False, default='')
...
class Close_orders(Base):
    ...
    toner = Column(Integer, nullable=False, default='0')
    opc = Column(Integer, nullable=False, default='0')
    pcr = Column(Integer, nullable=False, default='0')
    wiper_blade = Column(Integer, nullable=False, default='0')
    recovery_blade = Column(Integer, nullable=False, default='0')
    develop_blade = Column(Integer, nullable=False, default='0')
    doctor_blade = Column(Integer, nullable=False, default='0')
    barcode = Column(Integer, nullable=True, default='')
    mark = Column(String(250), nullable=True, default='')
    user_close = Column(String(250), nullable=False, default='0')
    date = Column(Date, nullable=True, default='')
